...
from cleaning_agent import HappyCleaningAgent
...
class care_home_world(responsibility_world):
    def __init__(self):
        super().__init__()
        simple_cleaning_agent_1 = HappyCleaningAgent(self, "cleaner1")
        simple_cleaning_agent_2 = HappyCleaningAgent(self, "cleaner2")
