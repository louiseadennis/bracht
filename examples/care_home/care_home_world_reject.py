...
from cleaning_agent import AngryCleaningAgent, CleaningAgent
...
class care_home_world(responsibility_world):
    ...
    def do(self, agent, task):
        ...
        if (task.name == "clean"):
            ...
            elif (agent.name == "cleaner_spare" and self.location_cleaner_2 == 0):
                self.remove_perception("spill_stairs")
            elif (agent.name == "cleaner_spare" and self.location_cleaner_2 == 4):
                self.remove_perception("spill_hall")
