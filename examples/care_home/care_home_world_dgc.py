...
class care_home_world(responsibility_world):
    def __init__(self):
        ...
        self.location_cleaner_1 = 1 # near stairs
        self.location_cleaner_2 = 3 # at hall
    ...
    def update_perceptions(self):
        ...
        if self.iterations == 1:
            self.add_percept('broken_cleaner_1')
    ...
    def update_locations(self):
        ...
        elif (self.location_cleaner_1 == 1):
            self.add_percept('near_stairs_cleaner_1')
        elif (self.location_cleaner_1 == 2):
        ...
        elif (self.location_cleaner_2 == 1):
            self.add_percept('near_stairs_cleaner_2')
        elif (self.location_cleaner_2 == 2):
